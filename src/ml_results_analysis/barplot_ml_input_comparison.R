...
expansion_intersection_results_train <- read.csv(paste0("../../data/ML_out/two_class/optm/expansion_intersection/metrics/sum_metrics_train_res.csv"))
expansion_union_results_train <- read.csv(paste0("../../data/ML_out/two_class/optm/expansion_union/metrics/sum_metrics_train_res.csv"))
dd_expansion_train <- read.csv(paste0("../../data/ML_out/two_class/optm/data_driven_expansion/metrics/sum_metrics_train_res.csv"))
disgenet_expansion_train <- read.csv(paste0("../../data/ML_out/two_class/optm/disgenet_expansion/metrics/sum_metrics_train_res.csv"))
...
expansion_intersection_results_test <- read.csv(paste0("../../data/ML_out/two_class/optm/expansion_intersection/metrics/sum_metrics_test.csv"))
expansion_union_results_test <- read.csv(paste0("../../data/ML_out/two_class/optm/expansion_union/metrics/sum_metrics_test.csv"))
dd_expansion_test <- read.csv(paste0("../../data/ML_out/two_class/optm/data_driven_expansion/metrics/sum_metrics_test.csv"))
disgenet_expansion_test <- read.csv(paste0("../../data/ML_out/two_class/optm/disgenet_expansion/metrics/sum_metrics_test.csv"))
...
results_train_dd_dgn <- rbind(dgn_results_train, disgenet_expansion_train,
...
results_test_dd_dgn <- rbind(dgn_results_test, disgenet_expansion_test,
