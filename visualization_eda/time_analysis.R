...
omnipath_intersection_results <- get(load("../../data/ML_out/two_class/optm/omnipath_intersection/results.Rda"))
omnipath_union_results <- get(load("../../data/ML_out/two_class/optm/omnipath_union/results.Rda"))
dd_expansion <- get(load("../../data/ML_out/two_class/optm/data_driven_expansion/results.Rda"))
dgn_expansion <- get(load("../../data/ML_out/two_class/optm/dgn_expansion/results.Rda"))
...
op_intersection_time <- as.data.frame(omnipath_intersection_results$times)
op_intersection_time$dim <- 256
op_union_time <- as.data.frame(omnipath_union_results$times)
op_union_time$dim <- 1553
dd_expansion_time <- as.data.frame(dd_expansion$times)
dd_expansion_time$dim <- 744
dgn_expansion_tome <- as.data.frame(dgn_expansion$times)
dgn_expansion_tome$dim <- 1065
